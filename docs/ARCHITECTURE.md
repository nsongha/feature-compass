...
- [API Reference](./API_REFERENCE.md) — App methods, JSON schemas, i18n keys
- [Security](./SECURITY.md) — API key handling, XSS protection, threat model
- [Contributing](./CONTRIBUTING.md) — Code style, design tokens, PR workflow
- [Known Issues](./KNOWN_ISSUES.md) — Known issues & workarounds
